...
struct ZoomCullingMetadataTests {
    ...
    @Test
    func `vital culling and completed CLIP evidence create concise rows`() {
        ...
        let metadata = ZoomCullingMetadata(
            ...
            clipSemanticMatch: ZoomCullingMetadata.CLIPSemanticMatch(
                rank: 3,
                score: 0.27,
            ),
            clipSimilarity: .distance(0.12),
        )
