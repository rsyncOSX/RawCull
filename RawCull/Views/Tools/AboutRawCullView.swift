    ...
    private var aboutHeader: some View {
        HStack(alignment: .top, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Fast Sony RAW culling with local CLIP semantic search and similarity, SAM 3 or EfficientSAM Deep Review, and built-in Vision fallback when an optional model is unavailable.")
                    .font(.callout)
                    .foregroundStyle(.secondary)
